...
\centering
	\setlength{\extrarowheight}{3pt}
	    ...
	    \hline
        \multicolumn{1}{|l}{CU_D02}     & \multicolumn{1}{Y|}{\textbf{Aviso de dispositivo encendido} } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A1.3. Finaliza el caso de uso.
	    ...
	    \end{tabular}
	\label{table:cu-d-02}
	\caption{Caso de Uso D02 - Dispositivo notifica que está encendido.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{r{1.85cm}|Y}
	    \hline
        \multicolumn{1}{|l}{CU_D03}     & \multicolumn{1}{Y|}{\textbf{Realizar tarea pendiente} } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
4. Finaliza el caso de uso.
	    ...
	    \end{tabular}
	\label{table:cu-d-03}
	\caption{Caso de Uso D03 - Realizar tarea pendiente.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A02}     & \multicolumn{1}{Y|}{\textbf{Crear nuevo tipo de tarea}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
\\ \cline{1-2}
	    ...
	    \end{tabular}
	\label{table:cu_A02}
	\caption{Caso de Uso A02 - Creacción de nuevo tipo de tarea.}
\end{table}
    %% FRONT
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{r{1.85cm}|Y}
	    \hline
        \multicolumn{1}{|l}{CU_A03}     & \multicolumn{1}{Y|}{\textbf{Asignar tarea} } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A05}     & \multicolumn{1}{Y|}{\textbf{Recolectar tareas de un dispositivo}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A07}     & \multicolumn{1}{Y|}{\textbf{Obtener lista de dispositivos}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.B.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A07}
	\caption{Caso de Uso A07 - Cambiar configuración de dispositivos.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A08}     & \multicolumn{1}{Y|}{\textbf{Obtener actividad de un dispositivo}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A08}
	\caption{Caso de Uso A08 - Obtener actividad de un dispositivo.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A09}     & \multicolumn{1}{Y|}{\textbf{Obtener actividad de un usuario}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A09}
	\caption{Caso de Uso A09 - Obtener actividad de un usuario}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A10}     & \multicolumn{1}{Y|}{\textbf{Añadir una nueva localidad}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A10}
	\caption{Caso de Uso A10 - Añadir una nueva localidad.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A11}     & \multicolumn{1}{Y|}{\textbf{Añadir nuevo usuario}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A11}
	\caption{Caso de Uso A11 - Añadir nuevo usuario.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A12}     & \multicolumn{1}{Y|}{\textbf{Asignar dispositivo a cliente}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
	    Un administrador solicita la información más específica de un usuario del sistema. \newline
	    }  \\ \cline{1-2}
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A12}
	\caption{Caso de Uso A12 - Asignar dispositivo a un usuario.}
\end{table}
...
\centering
	\setlength{\extrarowheight}{3pt}
		\begin{tabular}{rc{1.85cm}|Y{8cm}}
	    \hline
        \multicolumn{1}{|l}{CU_A13}     & \multicolumn{1}{Y|}{\textbf{Dessignar dispositivo a usuario}  } \\
	    \hline \hline
	    \multicolumn{1}{|l}{Descripción}     & \multicolumn{1}{Y|}{
...
2.A2.1. El servidor detecta un error en la información obtenida y devuelve error. \newline
	    ...
	    \end{tabular}
	\label{table:cu_A13}
	\caption{Caso de Uso A13 - Desasignar dispositivo a usuario.}
\end{table}
