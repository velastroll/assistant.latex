...
\input{secciones/2estadoarte/src/1intro}

\section{Requisitos mínimos}
\input{secciones/2estadoarte/src/2reqmin.tex}

\section{Mercado}
\label{mercato}
\input{secciones/2estadoarte/src/3.mercado.tex}

    \subsection{Google Assistant}
    \input{secciones/2estadoarte/src/31google}
    
    \subsection{Amazon Echo}
    \input{secciones/2estadoarte/src/32amazon.tex}
    
    \subsection{Mycroft}\label{Microft}
    \input{secciones/2estadoarte/src/34mycroft.tex}
    
    \subsection{Snips AI}
    \input{secciones/2estadoarte/src/35snips.tex}
